...
export const startupConfig: IStartupConfig = {
  ...
  producerStreamName: validateEnvVar('PRODUCER_STREAM', 'string'),
  consumerStreamName: validateEnvVar('CONSUMER_STREAM', 'string'),
  streamSubject: validateEnvVar('STREAM_SUBJECT', 'string'),
