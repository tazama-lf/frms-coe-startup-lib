...
export default defineConfig([
  ...
  //Adding Relay Services to ignore since they're deprecated.
  globalIgnores(['**/coverage/**', '**/lib/**', '**/node_modules/**', '**/__tests__/**', '*.ts', 
    'src/services/natsRelayService.ts',
    'src/services/rabbitMQRelayService.ts',
    'src/services/bigQueryRelayService.ts',
    'src/services/googleBucketsService.ts',
    'src/services/restRelayService.ts']),
  {
    files: ['**/*.ts'],
    plugins: {
